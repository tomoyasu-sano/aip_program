...
def logic7(file_name, table_len, table_list):
    ...
    for table, value3, value2, value1 in zip(table_list, df3, df2, df1):
        if  threshold3_0<= value3 < threshold3_1 and threshold2_0<= value2 < threshold2_1  and threshold1_0<= value1 < threshold1_1 :
            tables.append(table)
...
if __name__ == "__main__":
    ...
    tables = logic7(file_name, table_len, table_list)
    print(tables)
