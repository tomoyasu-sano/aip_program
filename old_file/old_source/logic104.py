...
#    seq_arrs, target_arrs = utility.sequence_data_logic2(y, seq_length, threshold_1, threshold_2, threshold_3)
...
def logic4(file_name, table_len, start_table, table_number):
    ...
    #for table in range(tables):
        ...
        for seq, sd, target, td in zip(seq_arrs, seq_days, target_arrs, target_days):
            ...
            stl =STL(df, period=6, robust=True)
            stl = stl.fit()
